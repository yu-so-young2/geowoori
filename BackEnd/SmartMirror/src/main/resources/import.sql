...
-- 거울 ( 거울 시리얼넘버도 본인 마음대로!! )
insert into mirror (serial_number, nickname, user_key) values ("SO98-YOUNG0911", "쏘영이네 똑쟁이 거울", 1);
...
-- 멤버 ( kids_mode: true(1) false(0)  / user_key: 본인에 맞는 거! )
insert into member (nickname, birth, face_image, kids_mode, user_key) values ("노노", "1993-02-03", "hyeonjung.jpg", 1, 2);
...
-- 멤버 ( kids_mode: true(1) false(0)  / user_key: 본인에 맞는 거! )
insert into member (nickname, birth, face_image, kids_mode, user_key) values ("영현이", "1996-12-21", "younghyun.jpg", 1, 3);
...
-- 멤버 ( kids_mode: true(1) false(0)  / user_key: 본인에 맞는 거! )
insert into member (nickname, birth, face_image, kids_mode, user_key) values ("BM", "1996-11-04", "bm.jpg", 0, 4);
...
-- 멤버 ( kids_mode: true(1) false(0)  / user_key: 본인에 맞는 거! )
insert into member (nickname, birth, face_image, kids_mode, user_key) values ("짱윤", "1997-09-01", "JY.jpg", 1, 5);
...
-- 멤버 ( kids_mode: true(1) false(0)  / user_key: 본인에 맞는 거! )
insert into member (nickname, birth, face_image, kids_mode, user_key) values ("동밍", "1995-07-10", "DM.jpg", 0, 6);
