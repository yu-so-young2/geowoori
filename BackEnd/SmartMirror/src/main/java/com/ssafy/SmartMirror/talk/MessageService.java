...
//    private static final String MSG_SEND_SERVICE_URL = "https://kapi.kakao.com/v2/api/talk/memo/scrap/send";
    ...
    public boolean sendMessage2(String accessToken, DefaultMessageDto msgDto) throws JSONException {
...
//        templateObj.put("button_title", msgDto.getBtnTitle());
        ...
        templateObj.put("buttons", buttons);
    ...
    public boolean sendMessage(String accessToken, DefaultMessageDto msgDto) throws JSONException {
        ...
        MultiValueMap<String, String> parameters = new LinkedMultiValueMap<>();
        parameters.add("template_id", "89905");
