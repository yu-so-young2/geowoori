  ...
  var lovepp = setInterval(function () {
    ...
    $(".heartdiv").append(
      "<div class='heartpp' style='width:" +
        r_size +"px;height:" +
        r_size +"px;left:" +
        r_left +"%; background:rgba(255,"+(r_bg - 25)+"," +r_bg +",1);-webkit-animation:lovepp " +
        // r_time +
    ...
    $(".heartdiv").append(
      "<div class='heartpp' style='width:" +
        (r_size - 10) +"px;height:" +
        (r_size - 10) +"px;left:" +
        (r_left + r_num) +"%;background:rgba(255," +
        (r_bg - 25) +"," +
        (r_bg + 25) +",1);-webkit-animation:lovepp " +
        (r_time + 5) +"s ease;-moz-animation:lovepp " +
        // (r_time + 5) +
        // "s ease;-ms-animation:lovepp " +
        // (r_time + 5) +
        // "s ease;animation:lovepp " +
